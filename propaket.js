...
const propaketData = {
    // 1. Полиэтиленовые белые (вертикальные)
    pvd_white: {
    ...
    // 2. Полиэтиленовые цветные/черные (вертикальные)
    pvd_color: {
    ...
    // 4. Бумажные пакеты плотные 260 гр (Цветные горизонтальные)
    paper_color: {
        name: "Бумажный плотный цветной (горизонтальный)",
        sizes: {
    ...
    // 5. Крафт пакет стандартный 80 гр (бурый, вертикальный)[cite: 1]
    kraft_brown: {
    ...
    // 6. Крафт пакет стандартный 80 гр (белый, вертикальный)[cite: 1]
    kraft_white: {
    ...
    // 7. НОВОЕ: Крафт пакет плотный горизонтальный (бурый / белый)
    kraft_horizontal: {
